...
def main():
    ...
    pesanDekripsi= "FCPFCSFQFQMTSQADJFNQYXPEVAARRFNBNOGTVAGKCCBCEDEEGWPRLTVVHHRHNBPRSNGA"
    kunci = 'NINDYA'
    mode1 = 'enkripsi'
    mode2 = 'dekripsi' 
...
def main():
    ...
    text = 'FCPFCSFQFQMTSQADJFNQYXPEVAARRFNBNOGTVAGKCCBCEDEEGWPRLTVVHHRHNBPRSNGA'#Pesan yang akan di enkripsi
    key = [3, 2]
    ...
    print('Ciphertext : RIVRIERYRYMHEYCLDRPYWTVONCCBBRPFPSUHNCUGIIFIOLOOUQVBJHNNXXBXPFVBEPUC')
